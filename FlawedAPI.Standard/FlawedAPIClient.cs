// <copyright file="FlawedAPIClient.cs" company="APIMatic">
...
using System.Linq;
using APIMatic.Core;
using FlawedAPI.Standard.Controllers;
using FlawedAPI.Standard.Http.Client;
using FlawedAPI.Standard.Utilities;

namespace FlawedAPI.Standard
{
    /// <summary>
    /// The gateway for the SDK. This class acts as a factory for Controller and
    /// holds the configuration of the SDK.
    /// </summary>
    public sealed class FlawedAPIClient : IConfiguration
    {
        ...
        /// <summary>
        /// Creates an object of the FlawedAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> FlawedAPIClient.</returns>
        internal static FlawedAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("FLAWED_API_STANDARD_ENVIRONMENT");
            string defaultHost = System.Environment.GetEnvironmentVariable("FLAWED_API_STANDARD_DEFAULT_HOST");
        ...
        {
            private Environment environment = FlawedAPI.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>FlawedAPIClient.</returns>
            public FlawedAPIClient Build()
            {
                return new FlawedAPIClient(
                    environment,
                    defaultHost,
                    httpCallback,
