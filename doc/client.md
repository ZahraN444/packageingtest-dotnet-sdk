...
| `ToBuilder()` | Creates an object of the Flawed APIClient using the values provided for the builder. | `Builder` |

## Flawed APIClient Builder Class

Class to build instances of Flawed APIClient.
